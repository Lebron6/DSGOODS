...
public static final  String EMAIL="EMAIL";
    ...
    private void commit() {
        ...
        HttpUtil.createRequest(TAG, BaseUrl.getInstence().saveEmail()).saveEmail(PreferenceUtils.getInstance().getUserToken(), getIntent().getStringExtra(EMAIL),etEmailCode.getText().toString()).enqueue(new Callback<ApiResponse>() {
            @Override
