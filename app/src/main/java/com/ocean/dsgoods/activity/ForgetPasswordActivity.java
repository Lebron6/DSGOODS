    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_commit:
                ...
                commit(etCompanyNum.getText().toString(),etAccount.getText().toString(), etPhoneCode.getText().toString(), etPassword.getText().toString());
                break;
        }
    }
    private void commit(String companyNum,String phone, String phoneCode, String password) {
        HttpUtil.createRequest(TAG, BaseUrl.getInstence().passwordForget()).passwordForget(companyNum,phone,phoneCode,password).enqueue(new Callback<ApiResponse>() {
            @Override
