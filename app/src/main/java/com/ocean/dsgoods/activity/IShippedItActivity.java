...
import com.ocean.dsgoods.fragment.NShippedFragment;
import com.ocean.dsgoods.fragment.YBillTypeFragment;
import com.ocean.dsgoods.fragment.YShippedFragment;
...
/**
 * Created by James on 2020/10/23.
 * 我发运的
 */
public class IShippedItActivity extends BaseActivity{
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, IShippedItActivity.class);
    ...
    protected void initTitle() {
        ...
        manger.setTitle("我发运的");
        manger.setBack();
    }

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_i_shipped_it;
    }

    @Override
    protected void initViews() {
        List<Fragment> fragments = new ArrayList<>();
        fragments.add(new NShippedFragment());
        fragments.add(new YShippedFragment());
