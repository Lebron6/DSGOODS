...
import com.ocean.dsgoods.fragment.NTookFragment;
import com.ocean.dsgoods.fragment.YBillTypeFragment;
import com.ocean.dsgoods.fragment.YTookFragment;
 ...
 * 我收的
 */
public class ITookItActivity extends BaseActivity {
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, ITookItActivity.class);
    ...
    protected void initViews() {
        ...
        fragments.add(new NTookFragment());
        fragments.add(new YTookFragment());
