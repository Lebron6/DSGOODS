...
public class SettingNewPasswordActivity extends BaseActivity {
    ...
    public void onViewClicked() {
        ...
        HttpUtil.createRequest(TAG, BaseUrl.getInstence().savePassword()).changePassword(PreferenceUtils.getInstance().getUserToken(),etPassword.getText().toString()).enqueue(new Callback<ApiResponse>() {
            @Override
