...
public class StaffManagementAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (TextUtils.isEmpty(datas.getList().get(position).getDepartment())){
            viewHolder.tvStaffName.setText(datas.getList().get(position).getName());
        }else{
            viewHolder.tvStaffName.setText(datas.getList().get(position).getDepartment() + "-" + datas.getList().get(position).getName());
        }
        viewHolder.tvStaffName.setText(datas.getList().get(position).getDepartment() + "-" + datas.getList().get(position).getName());
