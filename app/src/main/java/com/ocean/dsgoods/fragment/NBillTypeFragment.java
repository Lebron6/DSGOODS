 ...
 * 提单管理-未完成
 */
public class NBillTypeFragment extends BaseFragment {
    ...
    public NBillTypeFragment() {
    }
    @SuppressLint("ValidFragment")
    public NBillTypeFragment(int type) {
        this.type=type;
    }
    @Override
    ...
    protected void initViews() {
        ...
        for (int i = 0; i <titles.length ; i++) {
            fragments.add(new BillListFragment(titles[i]));
        }
        ...
        tabBill.setViewPager(getActivity(), titles, vpContent, R.color.colorGray, R.color.colorMain, 14, 14, 17, true, R.color.colorMain, 0f, 15f, 15f, 42);
