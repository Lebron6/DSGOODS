 ...
 * 我发运的-未完成
 */
public class NTookFragment extends BaseFragment {
    ...
    private void getData() {
        HttpUtil.createRequest(TAG, BaseUrl.getInstence().pickupList()).pickupList(PreferenceUtils.getInstance().getUserToken(), page + "", "1").enqueue(new Callback<ApiResponse<PickupData>>() {
            @Override
