package com.ocean.dsgoods.view.togglebutton;
...
import com.ocean.dsgoods.view.togglebutton.facebook.rebound.SimpleSpringListener;
...
import com.ocean.dsgoods.view.togglebutton.facebook.rebound.SpringUtil;
...
public class ToggleButton extends View {
	...
	/** 开启颜色*/
//	private int onColor = Color.parseColor("#34C759");//绿色
	private int onColor = Color.parseColor("#3D68EB");//蓝色
//	private int onColor = Color.parseColor("#8954AF");//紫色
	/** 关闭颜色*/
	...
	public void setup(AttributeSet attrs) {
		...
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_borderWidth_toggle, borderWidth);
